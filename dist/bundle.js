...
/* harmony default export */ __webpack_exports__["a"] = (EventCenter);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_style_scss__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_noteManager__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_waterFall__ = __webpack_require__(13);
...
__WEBPACK_IMPORTED_MODULE_4_jquery___default()('.add-note').on('click', function () {
...
__WEBPACK_IMPORTED_MODULE_0__modules_event__["a" /* default */].on('waterfall', function () {
  __WEBPACK_IMPORTED_MODULE_3__modules_waterFall__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_4_jquery___default()('#note-container'));
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__toast__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__note__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event__ = __webpack_require__(1);
...
const NoteManager = function () {
  function loadNotes() {
    __WEBPACK_IMPORTED_MODULE_3_jquery___default.a.get('/api/notes').done(function (response) {
      if (response.status == 0) {
        __WEBPACK_IMPORTED_MODULE_3_jquery___default.a.each(response.data, (index, item) => {
          new __WEBPACK_IMPORTED_MODULE_1__note__["a" /* default */]({
            id: item.id,
            content: item.content
          });
        });
        // 瀑布流布局
        __WEBPACK_IMPORTED_MODULE_2__event__["a" /* default */].trigger('waterfall');
      } else {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])(response.errorMsg);
      }
    }).fail(function () {
      Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])('网络异常');
    });
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__toast__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__event__ = __webpack_require__(1);
...
class Note {
  constructor(opts) {
    this.defaultOpts = {
      id: '', //note的id
      $ct: __WEBPACK_IMPORTED_MODULE_2_jquery___default()('#note-container').length > 0 ? __WEBPACK_IMPORTED_MODULE_2_jquery___default()('#note-container') : __WEBPACK_IMPORTED_MODULE_2_jquery___default()('body'),
  ...
  createNote() {
    ...
    `;
    this.$note = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(template);
    if (!this.id) {
      // 设置placeholder
  ...
  delete() {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.post('/api/notes/delete', {
      id: this.id
    }).done(ret => {
      if (ret.status === 0) {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])('delete success');
        this.$note.remove();
        __WEBPACK_IMPORTED_MODULE_1__event__["a" /* default */].trigger('waterfall');
      } else {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])(ret.errorMsg);
      }
    });
  }

  edit(message) {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.post('/api/notes/edit', {
      id: this.id,
      note: message
    }).done(ret => {
      if (ret.status === 0) {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])('update success');
      } else {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])(ret.errorMsg);
      }
    });
  ...
  add(message) {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.post('/api/notes/add', {
      note: message
    }).done(ret => {
      console.log(ret);
      if (ret.status === 0) {
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])('add success');
      } else {
        this.$note.remove();
        __WEBPACK_IMPORTED_MODULE_1__event__["a" /* default */].trigger('waterfall');
        Object(__WEBPACK_IMPORTED_MODULE_0__toast__["a" /* default */])('ret.errorMsg');
...
var WaterFall = function () {
  ...
  function render($element) {
    ...
    let nodeWidth = $items.outerWidth(true),
        colNum = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).width() / nodeWidth),
        colSumHeight = [];
    ...
    $items.each(function () {
      let $item = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this),
